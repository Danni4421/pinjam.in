...
{
    private static string $base_path = "assets/dist/images/uploads";
    ...
    public static function move(string $type, string $filename, string $key): string
    {
        ...
        if (move_uploaded_file($_FILES[$key]["tmp_name"], $target_path)) {
            ...
            MessageHelper::message("Error", "danger", "Gagal Menambahkan Foto Profil");
            return "";
        }
    }
    ...
    public static function get(string $path, string $type): string
    {
        ...
        switch ($type) {
            case "profile":
                return static::$base_path . '/../default.profile.photo.jpeg';
            case "form":
                return static::$base_path . '/../default.jpg';
            case "ruang-kelas":
                return static::$base_path . '/../ruang.kelas.png';
            case "ruang-dosen":
                return static::$base_path . '/../ruang.dosen.jpg';
            default:
                return "";
        }
    }
