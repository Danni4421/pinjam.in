...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        require_once 'assets/components/admin/ruang/modal/kelas/AddJadwalRuang.php';
        require_once 'assets/components/admin/ruang/modal/kelas/EditJadwalRuang.php';
        require_once 'assets/components/admin/ruang/modal/AddFasilitas.php';
        require_once 'assets/components/admin/ruang/modal/EditFasilitas.php';
        ?>
    </div>
    ...
    <script src="<?= $relativePath ?>assets/dist/scripts/admin/ruang/jadwal.js"></script>
    <script>
